...
function createGetUrl(options) {
  function getUrl(req, _signal) {
    return __async(this, null, function* () {
      ...
      const resp = yield fetch(req.url, init2);
      const headers = {};
...
var _scryptAsync = function(passwd, salt, N3, r, p, dkLen, onProgress) {
  return __async(this, null, function* () {
    return yield scryptAsync(passwd, salt, { N: N3, r, p, dkLen, onProgress });
  });
};
...
function getGasStationPlugin(url) {
  return new FetchUrlFeeDataNetworkPlugin(url, (fetchFeeData, provider, request) => __async(this, null, function* () {
    ...
    let response;
    try {
      const [_response, _feeData] = yield Promise.all([
        request.send(),
        fetchFeeData()
      ]);
      response = _response;
...
var AbstractProvider = class {
  ...
  getBlockNumber() {
    return __async(this, null, function* () {
      const blockNumber = getNumber(yield this.#perform({ method: "getBlockNumber" }), "%response");
  ...
  getFeeData() {
    return __async(this, null, function* () {
      ...
      const getFeeDataFunc = () => __async(this, null, function* () {
        const { _block, gasPrice, priorityFee } = yield resolveProperties({
          _block: this.#getBlock("latest", false),
          gasPrice: (() => __async(this, null, function* () {
            try {
              const value = yield this.#perform({ method: "getGasPrice" });
          ...
          priorityFee: (() => __async(this, null, function* () {
            try {
              const value = yield this.#perform({ method: "getPriorityFee" });
              return getBigInt(value, "%response");
            } catch (error) {
            }
            return null;
  ...
  #call(tx, blockTag, attempt) {
    return __async(this, null, function* () {
      ...
      try {
        return hexlify(yield this._perform({ method: "call", transaction, blockTag }));
      } catch (error) {
  ...
  #checkNetwork(promise) {
    return __async(this, null, function* () {
      const { value } = yield resolveProperties({
  ...
  call(_tx) {
    return __async(this, null, function* () {
      const { tx, blockTag } = yield resolveProperties({
  ...
  #getAccountValue(request, _address, _blockTag) {
    return __async(this, null, function* () {
      ...
      return yield this.#checkNetwork(this.#perform(Object.assign(request, { address, blockTag })));
    });
  }
  getBalance(address, blockTag) {
    return __async(this, null, function* () {
      return getBigInt(yield this.#getAccountValue({ method: "getBalance" }, address, blockTag), "%response");
    });
  }
  getTransactionCount(address, blockTag) {
    return __async(this, null, function* () {
      return getNumber(yield this.#getAccountValue({ method: "getTransactionCount" }, address, blockTag), "%response");
    });
  }
  getCode(address, blockTag) {
    return __async(this, null, function* () {
      return hexlify(yield this.#getAccountValue({ method: "getCode" }, address, blockTag));
    });
  }
  getStorage(address, _position, blockTag) {
    return __async(this, null, function* () {
      const position = getBigInt(_position, "position");
      return hexlify(yield this.#getAccountValue({ method: "getStorage", position }, address, blockTag));
    });
  }
  // Write
  broadcastTransaction(signedTx) {
    return __async(this, null, function* () {
      const { blockNumber, hash: hash2, network } = yield resolveProperties({
  ...
  getBlock(block, prefetchTxs) {
    return __async(this, null, function* () {
      const { network, params } = yield resolveProperties({
        network: this.getNetwork(),
  ...
  getTransactionReceipt(hash2) {
    return __async(this, null, function* () {
      ...
      if (params.gasPrice == null && params.effectiveGasPrice == null) {
        const tx = yield this.#perform({ method: "getTransaction", hash: hash2 });
        if (tx == null) {
  ...
  getTransactionResult(hash2) {
    return __async(this, null, function* () {
      const { result } = yield resolveProperties({
        network: this.getNetwork(),
  ...
  removeAllListeners(event) {
    return __async(this, null, function* () {
      if (event) {
        const { tag, started, subscriber } = yield this.#getSub(event);
        if (started) {
          subscriber.stop();
        }
...
var JsonRpcSigner = class extends AbstractSigner {
  ...
  sendUncheckedTransaction(_tx) {
    return __async(this, null, function* () {
      ...
      if (tx.gasLimit == null) {
        promises.push((() => __async(this, null, function* () {
          tx.gasLimit = yield this.provider.estimateGas(__spreadProps(__spreadValues({}, tx), { from: this.address }));
        }))());
      }
      if (tx.to != null) {
        const _to = tx.to;
...
var JsonRpcApiProvider = class _JsonRpcApiProvider extends AbstractProvider {
  ...
  getSigner(address) {
    return __async(this, null, function* () {
      ...
      const { accounts } = yield resolveProperties({
        network: this.getNetwork(),
  ...
  _perform(req) {
    return __async(this, null, function* () {
      if (req.method === "getTransactionResult") {
        const { trace, tx } = yield resolveProperties({
...
var FallbackProvider = class _FallbackProvider extends AbstractProvider {
  ...
  _detectNetwork() {
    return __async(this, null, function* () {
      return Network.from(getBigInt(yield this._perform({ method: "chainId" })));
    });
  }
  ...
  _perform(req) {
    return __async(this, null, function* () {
      if (req.method === "broadcastTransaction") {
        ...
        const broadcasts = this.#configs.map((_0, _1) => __async(this, [_0, _1], function* ({ provider, weight }, index) {
          try {
...
var HDNodeWallet = class _HDNodeWallet extends BaseWallet {
  ...
  encrypt(password, progressCallback) {
    return __async(this, null, function* () {
      return yield encryptKeystoreJson(this.#account(), password, { progressCallback });
    });
  }
  /**
...
var Wallet = class _Wallet extends BaseWallet {
  ...
  encrypt(password, progressCallback) {
    return __async(this, null, function* () {
      const account = { address: this.address, privateKey: this.privateKey };
      return yield encryptKeystoreJson(account, password, { progressCallback });
    });
  }
  /**
   *  Returns a [JSON Keystore Wallet](json-wallets) encryped with
